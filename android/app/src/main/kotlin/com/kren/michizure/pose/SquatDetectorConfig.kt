...
data class SquatDetectorConfig(
    ...
    val targetHostAnalysisFps: Int = 12,
    val hostPreviewWidth: Int = 640,
    val hostPreviewHeight: Int = 480,
    val hostJpegQuality: Int = 60,
    ...
    val returnStandingAbsoluteKneeDeg: Double = 155.0,
