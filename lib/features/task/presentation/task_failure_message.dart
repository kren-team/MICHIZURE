...
String taskFailureMessage(Object error) {
  ...
  return switch (kind) {
    ...
    TaskFailureKind.groupRequired => 'Taskを開始するにはグループへの所属が必要です。',
    ...
    TaskFailureKind.noActiveTask => '実行中のTaskを復元できませんでした。',
    ...
    TaskFailureKind.offline => 'Taskの更新にはネットワーク接続が必要です。',
    TaskFailureKind.rulesDenied => 'このTaskを更新する権限がありません。',
    TaskFailureKind.invalidData => 'Taskデータが不正です。再読み込みしてください。',
    TaskFailureKind.unknown => 'Taskを更新できませんでした。もう一度お試しください。',
  };
}
